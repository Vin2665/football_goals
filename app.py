...
Relative_humidity = st.number_input('Enter Humidity(%) 2m above ground',min_value=1,max_value=120.00,step=1.00)
...
if st.button('Predict Total Goals in match'):
        ...
        st.title("Predicted Match Goals Are " + str(data.predict(query)[0]))
